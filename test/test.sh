...
url="https://github.com/kelly-lin/12d-lang-server/releases/download/$version/12dls.exe"
if ! curl -fIs "https://github.com/kelly-lin/12d-lang-server/releases/download/$version/12dls.exe" >/dev/null; then
